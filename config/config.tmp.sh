...
DOCKER_REGISTRY_NAME=pro.registry.gitlab.metadata.dev.cf-deployments.org/base-infrastructure/docker-registry
# DOCKER_REGISTRY_NAME=hiiamtrong
...
REDIS_MASTER_EXTERNAL_HOST={MY_IPV4}
REDIS_MASTER_EXTERNAL_PORT=6379
